                ...
                <div class="card-body">
                  <form>
                    <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">No induk Pegawai</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-12">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Guru Bidang</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="radio disabled">
                          <label><input type="radio" name="optradio" disabled>Belok</label>
                    </div>
                                <div class="dropdown">
